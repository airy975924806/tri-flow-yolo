# --**--coding=utf-8--**--
# AUTHOR: AIRY
# NAME: main_gradcam.py
# TIME: 2023/4/3 上午8:32
import os
import random
import time
import argparse
...
parser.add_argument('--model-path', type=str, default="runs/train/muti_17_0.8comosaic_0.2scale_SoftIOU_17LABLE_960_again/weights/best.pt", help='Path to the model')
parser.add_argument('--img-path', type=str, default='/data/tri-test', help='input image path')
parser.add_argument('--output-dir', type=str, default='outputs/test/', help='output dir')
